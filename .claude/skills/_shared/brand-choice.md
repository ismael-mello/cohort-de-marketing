...
>
> **3. Já rodei /design-md, usa o que já tem** — você já tem `DESIGN.md` na raiz. Eu leio e aplico.
>
...
Se não existir, avise: *"Não achei DESIGN.md na raiz. Rode `/design-md` primeiro."* e encerre.
