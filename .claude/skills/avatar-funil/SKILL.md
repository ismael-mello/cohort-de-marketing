...
3. **Qual modo você consegue rodar:**
   - **Modo Rede (ideal):** você tem acesso à internet (bash, WebSearch, WebFetch, scripts). Você vai atrás do material sozinho nas fontes públicas. Vá para o Passo 1A.
   - **Modo Offline (fallback):** sem acesso à rede, ou o usuário já tem o material. O usuário cola, você analisa. Vá para o Passo 1B.
...
## Passo 2 — Analisar a dor (mesmo motor nos dois modos)
